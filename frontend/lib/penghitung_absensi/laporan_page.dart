                  ...
                  children: [
                    ...
                    Row(
                      children: [
                        ...
                        const SizedBox(width: 8),
                        Text(
                          'Filter tanggal (geser horizontal)',
                    ...
                    _DigitalDateFilters(
                      ...
                      onTahun: (v) => setState(() => _filterTahun = v),
                      onBulan: (v) => setState(() => _filterBulan = v),
                      onTanggal: (v) => setState(() => _filterTanggal = v),
                    ),
                    const SizedBox(height: 10),
                    Text(
                    ...
                    const SizedBox(height: 6),
                    Text(
                      'Pilih tahun, bulan, dan tanggal pada strip di atas; geser kiri/kanan jika banyak pilihan.',
                ...
                child: ClipRRect(
                  ...
                  child: LayoutBuilder(
                    builder: (context, constraints) {
                      ...
                      final tableW = viewportW < minTableW ? minTableW : viewportW;
